...
export function BrutalistCTA({
  ...
  subtitle = 'Give your team an AI data analyst. Connect your data in seconds and turn complex metrics into clear business decisions today.',
  primaryActionText = 'Start For Free',
  primaryActionUrl = '/register',
  secondaryActionText = 'Try The Playground',
  secondaryActionUrl = '#demo',
  backgroundWord = 'INSIGHTS',
}: BrutalistCTAProps) {
  return (
