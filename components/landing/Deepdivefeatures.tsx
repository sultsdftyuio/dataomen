...
import { CheckCircle2, Zap, Activity, Bell } from "lucide-react";
      ...
      <div style={{ maxWidth: 1240, margin: "0 auto" }}>
        ...
        <div className="grid-2" style={{ marginBottom: 160 }} ref={ref1}>
          ...
          <div className={`fu ${vis1 ? "vis" : ""}`} style={{ order: 1 }}>
            ...
            <p style={{ color: C.muted, fontSize: 18, lineHeight: 1.6, marginBottom: 32 }}>
              Arclis's semantic routing engine understands your business context.
              It translates plain English into perfectly optimized analytical queries
              in milliseconds, rendering presentation-ready charts instantly.
            </p>
        ...
        <div className="grid-2" ref={ref2}>
          ...
          <div className={`fu ${vis2 ? "vis" : ""}`} style={{ order: 2 }}>
            ...
            <p style={{ color: C.muted, fontSize: 18, lineHeight: 1.6, marginBottom: 32 }}>
              Don't just stare at dashboards. Our statistical engine continuously watches your connected
              streams. If conversion rates drop or API errors spike, Arclis alerts you immediately
              with the root cause.
            </p>
            <a href="#agents" className="btn-ghost" style={{ padding: "14px 28px" }}>
              Explore Monitoring Agents
            </a>
          </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                <div style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 12, padding: 20 }}>
                  ...
                  <p style={{ fontSize: 14, color: C.faint, lineHeight: 1.5 }}>
                    EMEA region conversion fell by 4.2% in the last hour. Correlated with a spike in Payment Gateway latency.
                  </p>
                </div>
