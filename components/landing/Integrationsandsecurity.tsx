      ...
      <div style={{ maxWidth: 1240, margin: "0 auto" }} ref={ref as React.RefObject<HTMLDivElement>}>
        ...
        <div id="security" className="bento-grid">
          ...
          <div className={`fu ${vis ? "vis" : ""}`} style={{
            ...
            <h3 className="pfd" style={{ fontSize: 32, marginBottom: 16 }}>Security by Design</h3>
            ...
            <a href="/security" style={{ color: C.blueLight, fontWeight: 700, fontSize: 15, display: "inline-flex", alignItems: "center", gap: 8, textDecoration: "none" }}>
              Explore our Security Architecture <ArrowRight size={16} />
            </a>
          ...
          <div className={`fu ${vis ? "vis" : ""}`} style={{
            ...
            <h3 className="pfd" style={{ fontSize: 26, color: C.navy, marginBottom: 20 }}>Infrastructure Guardrails</h3>
