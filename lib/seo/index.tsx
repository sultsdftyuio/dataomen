...
function hydrateRegistry() {
  ...
  try {
    ...
    // Fix: Process the flat map of slug -> SEOPageData generated by registry.ts
    for (const [slug, pageData] of Object.entries(seoRegistry)) {
      // ULTIMATE TYPE FIX: Use the 'in' operator to safely check for property existence 
      // on generic object types without triggering TypeScript boundary errors.
      if (!pageData || typeof pageData !== 'object' || !('type' in pageData)) {
        continue;
      }
