...
export const SETTINGS_SELECT =
  "tenant_id, company_name, sender_email, reply_to_email, website_url, stripe_account_id, email_provider_status, crawl_completion_email_enabled, key_last_updated, updated_at";
