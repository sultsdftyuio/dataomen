...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[20%] left-[-10%] w-[600px] h-[600px] rounded-full bg-[#F0F7FF] blur-[120px] z-0" />
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-center" style={{ color: C.muted }}>
            Log in to your <span className="font-semibold" style={{ color: C.navy }}>arcli</span> workspace.
          </p>
        </div>
