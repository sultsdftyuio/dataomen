      ...
      <main className="max-w-5xl mx-auto px-6 pt-32 pb-24 sm:pt-40 sm:pb-32">
        ...
        <header className="mb-24 text-center sm:text-left">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-slate-900 mb-6 leading-[1.1]">
            ...
            <span className="text-blue-700">Deterministically.</span>
          </h1>
        ...
        <section className="mb-24 border border-slate-200 bg-slate-50 rounded-2xl p-8 sm:p-12">
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            <div>
              <div className="text-blue-700 font-bold mb-2">False Positives</div>
            ...
            <div>
              <div className="text-blue-700 font-bold mb-2">Low Explainability</div>
              <p className="text-sm text-slate-600 leading-relaxed">
        ...
        <section className="mb-32">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="p-6 bg-slate-50 border border-slate-200 rounded-lg font-mono text-sm overflow-x-auto">
              <div className="text-slate-500 mb-4 border-b border-slate-200 pb-2">// Arcli Deterministic Risk Payload</div>
    ...
    "reset_on": ["invoice.paid", "user.login"]
          ...
          <div className="border-t border-slate-200 pt-16">
            ...
            <div className="grid sm:grid-cols-3 gap-8">
              <div className="p-6 bg-white border border-slate-200 rounded-lg shadow-sm">
                <div className="text-blue-700 font-bold mb-2 font-mono text-sm">Materialized Views</div>
                <p className="text-sm text-slate-600">Arcli pre-calculates high-risk states using background materialization, avoiding heavy analytical queries on your primary database.</p>
              </div>
              <div className="p-6 bg-white border border-slate-200 rounded-lg shadow-sm">
                <div className="text-blue-700 font-bold mb-2 font-mono text-sm">Cursor Pagination</div>
                <p className="text-sm text-slate-600">Batched processing and strict cursor pagination ensure evaluating inactivity limits stays O(1) in memory, regardless of your user base size.</p>
              </div>
              <div className="p-6 bg-white border border-slate-200 rounded-lg shadow-sm">
                <div className="text-blue-700 font-bold mb-2 font-mono text-sm">Complete Explainability</div>
                <p className="text-sm text-slate-600">Every score change generates an immutable audit log. You never have to guess <em>why</em> Arcli triggered a recovery email.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-32 bg-slate-50 border border-slate-200 rounded-2xl p-8 sm:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-4">
            ...
            <div>
              <div className="text-slate-900 font-semibold">Data Lead</div>
        ...
        <section className="mb-24">
          ...
          <div className="grid sm:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-bold text-slate-900 mb-2">What is deterministic churn scoring?</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-bold text-slate-900 mb-2">Why shouldn't I use AI for churn prediction?</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-bold text-slate-900 mb-2">How does Arcli combine Stripe data with app events?</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-bold text-slate-900 mb-2">Can I adjust thresholds for different customer tiers?</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
