...
export default function SettingsPage() {
  ...
  // Initialize form with multi-tenant storage tier options
                ...
                {selectedTier === "BYOS" && (
                  <div className="space-y-4 pt-4 border-t animate-in fade-in slide-in-from-top-2">
                    <div className="space-y-2">
                      ...
                      <Input {...register("byos_endpoint")} placeholder="https://abc.r2.cloudflarestorage.com" />
                    </div>
                    <div className="space-y-2">
                      <Label>Bucket Name</Label>
                      <Input {...register("byos_bucket")} placeholder="my-analytics-data" />
                    </div>
                    <div className="space-y-2">
                      <Label>Access Key ID</Label>
                      <Input {...register("byos_access_key")} type="password" placeholder="••••••••" />
                    </div>
                  </div>
                )}
              </CardContent>
